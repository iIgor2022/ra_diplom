...
const getItmesList = (path, categoryId, offset, searchQuery) => fetchData({
  path, categoryId, offset, searchQuery,
});
const getItem = (id) => fetchData(`items/:${id}`);
const postOrder = (body) => fetchData({ path: 'order', method: 'POST', body });

export {
  getTopSales, getCategoriesList, getItmesList, getItem, postOrder,
};
